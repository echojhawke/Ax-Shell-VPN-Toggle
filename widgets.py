...
from modules.vpn_popup import VpnPopup
...
class Widgets(Box):
    def __init__(self, **kwargs):
        ...
        self.vpn_popup = VpnPopup()
        # Set widgets reference after creation so vpn_popup can navigate
        self.vpn_popup.set_widgets_instance(self)
